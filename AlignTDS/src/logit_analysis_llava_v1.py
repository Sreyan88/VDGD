...
model_pairs = {
    "llava_v1": { "i2i": "liuhaotian/llava-llama-2-7b-chat-lightning-lora-preview", "i2b": "meta-llama/Llama-2-7b-chat-hf"},
}
...
def main():
    ...
    if args.mode == "i2i":
        ...
        tokenizer, model, image_processor, context_len = load_pretrained_model(
            model_path, "meta-llama/Llama-2-7b-chat-hf", model_name
        )
        device = model.device
